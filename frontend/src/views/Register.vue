<template>
    <div class="register">
        ...
        <div>
            <register_1 v-show="registerStep === 1" :userInformation="registerInformation.userInformation" @firstStepClear="firstStepClear"> </register_1>
            <register_2 v-show="registerStep === 2" :interestJob="registerInformation.userInterestJob" @secondStepClear="secondStepClear"> </register_2>
            <register_3 v-show="registerStep === 3" :interestJob="registerInformation.userInterestJob" :jobTags="registerInformation.userJobTags" @thirdStepClear="thirdStepClear"> </register_3>
            <register_4 v-show="registerStep === 4" :user="registerInformation"> </register_4>
        </div>
    </div>
</template>
